...
export const FileUpload = ({
  ...
  return (
    <div className="w-full h-full flex flex-col justify-between" {...getRootProps()}>
    <motion.div
      onClick={handleClick}
      whileHover="animate"
    ...
    >
        ...
        <div className="flex flex-col items-center justify-center">
                  ...
                  >
                    ...
                    {isImage && previewURL && (
                      <motion.img
                        ...
                        initial={{ opacity: 0 }}
                        animate={{ opacity: 1 }}
                        className="rounded-lg mt-4 object-cover max-h-48 w-full"
                      />
                    )}

                    <div className="flex text-sm flex-col md:flex-row items-start md:items-center justify-between w-full mt-2 text-neutral-600 dark:text-neutral-400">
                      <motion.p
                        initial={{ opacity: 0 }}
                        animate={{ opacity: 1 }}
          ...
          <p className="relative mt-10 z-20 font-sans font-bold text-neutral-700 dark:text-neutral-300 text-base">
            Upload file
          </p>
    ...
    <motion.button
      ...
      whileTap={{ scale: 0.95 }}
      className="px-6 py-2 rounded-xl bg-green-500 text-white font-semibold shadow-md hover:bg-green-600 transition-all duration-300 focus:outline-none focus:ring-2 focus:ring-green-400 focus:ring-offset-2"
    >
      Generate
    </motion.button>
  </div>
